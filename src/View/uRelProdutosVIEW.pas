...
procedure TfrmRelatorioDeProdutos.btnVisualizarClick(Sender: TObject);
var
  sPath: string;
begin
...
procedure TfrmRelatorioDeProdutos.btnConsultarClick(Sender: TObject);
begin
  ConsultaTodosProdutos;
end;

procedure TfrmRelatorioDeProdutos.btnSairClick(Sender: TObject);
begin
  close;
end;
