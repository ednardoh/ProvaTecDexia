...
procedure TfrmRelatorioDeVendas.btnVisualizarClick(Sender: TObject);
var
  sPath: string;
begin
...
procedure TfrmRelatorioDeVendas.btnConsultarClick(Sender: TObject);
begin
  ConsultaTodasVendas;
end;

procedure TfrmRelatorioDeVendas.btnSairClick(Sender: TObject);
begin
  close;
end;
