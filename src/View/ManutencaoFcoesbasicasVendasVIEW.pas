...
procedure TfrmManutencaoFuncoesbasicasVendas.btnRestaurarClick(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmManutencaoFuncoesbasicasVendas.btnSalvarClick(Sender: TObject);
begin
  inherited;
...
begin
  ...
  btnRestaurar.Enabled := bRestaurar;
  btnSalvar.Enabled    := bSalvar;
  btnSair.Enabled      := bSair;
end;
